...
void Arduino::on_night_mode_clicked()
{
    ui->night_label->setText("NIGHT MODE ON");
    arduino->write("N");
    ui->night_mode->setText("Turn off");

}

void Arduino::on_gas_read_clicked()
{
    arduino->write("z");
    QString value = arduino->read(3);
